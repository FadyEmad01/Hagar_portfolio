...
import { detectSocialPlatform, getSocialIcon } from "@/lib/social-icons"
...
export default function PostModal({ post, isOpen, onClose, onPostClick }: PostModalProps) {
  ...
  const relatedPosts = currentIndex !== -1 ? posts.slice(currentIndex + 1, currentIndex + 4) : []
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          onClick={onClose}
        >
          <div className="relative w-full max-w-full mx-auto px-6 xl:px-8"
          >
            <motion.div
              ref={modalRef}
                  ...
                  <header className="flex flex-col gap-y-3.5 mb-24">
                    <div className="flex justify-between gap-x-3.5">
                      <motion.h1
                        ...
                        className="text-2xl xl:text-4xl font-semibold uppercase text-ellipsis overflow-hidden line-clamp-2"
                      >
                        {post.title}
                      </motion.h1>
                      <motion.button
                        ...
                        {post.tags.map((tag, index) => (
                          ...
                          >
                            <Button
                              variant="outline"
                              size="sm"
                              className={`${backgroundClassName} text-black border-black rounded-full px-3 h-9 hover:rounded-lg hover:bg-transparent  transition-all duration-300`}
                              style={backgroundStyle}
                            >
                    ...
                    {post.externalUrl && (
                      ...
                      >
                        <Button
                          ...
                          className="text-black border-black bg-transparent hover:bg-transparent border border-solid rounded-full px-3 h-9 transition-colors flex justify-center items-center whitespace-nowrap hover:rounded-lg duration-300"
                        >
